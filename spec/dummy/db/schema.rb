...
ActiveRecord::Schema.define(version: 20_151_124_140_440) do
  ...
  add_index 'ecm_translations_translations', %w(locale key), name: 'index_ecm_translations_translations_on_locale_and_key', unique: true
end
